...
> douyin_manual_upload是抖音视频筛选并上传至 B 站的半自动化工具。用户可以先输入需要返回的视频数量，程序会按需抓取抖音作品，并在终端中展示视频 ID、标题、发布时间、点赞量、播放量及上传状态，支持人工选择单个、多个或全部视频进行下载和上传。已上传的视频不会被隐藏，而是通过状态标记方便用户识别和重新处理，从而减少重复爬取时间，提高视频筛选与发布效率。

![1](./assets/douyin_manual_upload1.png)

![1](./assets/douyin_manual_upload2.png)

![1](./assets/douyin_manual_upload3.png)
